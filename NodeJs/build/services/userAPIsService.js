    ...
    try {
      ...
      if (isExit) {
        let user = await db.User.findOne({
          ...
          // Chỉ lấy những cột cần thiết (Lấycột password để đăng nhập vào sau đó xoá nó đi để người call không thấy)
          raw: true
        });
        if (user) {
        ...
        userData.errCode = 1;
        userData.errMessage = "Your email: ".concat(email, " isn't exits in your system. Plz try other email!");
      }
      resolve(userData);
    } catch (e) {
      reject(e);
