        ...
        try {
            ...
            if (isExit) {
                let user = await db.User.findOne({
                    where: { email: email },
                    attributes: ['id', 'email', 'roleId', 'password', 'firstName', 'lastName'], // Chỉ lấy những cột cần thiết (Lấycột password để đăng nhập vào sau đó xoá nó đi để người call không thấy)
                    raw: true
                });
